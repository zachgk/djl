...
public class LgbmDataset implements NDArrayAdapter {
    ...
    LgbmDataset(NDManager manager, LgbmNDArray array) {
        this.manager = (LgbmNDManager) manager;
    ...
    LgbmDataset(NDManager manager, Path file) {
        this.manager = (LgbmNDManager) manager;
        this.shape = null;
    ...
    public LgbmNDArray getSrcArrayConverted() {
        ...
        if (a instanceof LgbmNDArray) {
            ...
            return new LgbmNDArray(manager, a.toByteBuffer(), a.getShape(), a.getDataType());
        }
    }
